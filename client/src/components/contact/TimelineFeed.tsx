...
const EVENT_COLORS: Record<string, string> = {
  ...
  followup_generated: "bg-primary/10 text-primary",
  ...
  scan_created: "bg-primary/10 text-primary",
  task_added: "bg-muted text-muted-foreground",
  ...
  event_attended: "bg-primary/10 text-primary",
  contact_merged: "bg-pink-100 text-pink-700 dark:bg-pink-900/40 dark:text-pink-300",
  contact_updated: "bg-muted text-muted-foreground",
};
